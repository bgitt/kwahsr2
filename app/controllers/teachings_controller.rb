class TeachingsController < ApplicationController
  ...
  # GET /teachings.json
  def index
    @teachings = Teaching.where('user_id = ?', current_user.id)
  end
  ...
  def create
    ...
    respond_to do |format|
      if @teaching.save
        format.html { redirect_to @teaching, notice: 'Successfully enrolled in class.' }
  ...
  def update
    respond_to do |format|
      if @teaching.update(teaching_params)
        format.html { redirect_to @teaching, notice: 'Class was successfully updated.' }
  ...
  def destroy
    @teaching.destroy
    respond_to do |format|
      format.html { redirect_to teachings_url, notice: 'Successfully dropped class.' }
  ...
  private
    ...
    def teaching_params
      params.require(:teaching).permit(:term, :course_id,  :user_id)
    end
end
